...
ITEMS = {
    ...
    'spear': ('Spear', 'mc:item/trident', 'standin', None),
...
SPINE = [
    ...
    node('table', 'station', 'Crafting Table', '3×3 grid', 'grid3', [
        ...
        row('2.2', 'now', [i('clay_ball', 5), i('stone_fire'), i('cobblestone', 3)], [i('forge')], 'shaped',
            'Your step "Stone → Forge". The forge needs cobblestone, so it follows the rock pickaxe.'),
        row('', 'now', [i('stick', 2), i('flint'), i('fiber')], [i('spear')], 'shapeless',
            'Kept as the reach weapon in this draft (Q6). Uses the trident sprite.'),
        ...
        row('', 'now', [i('flint'), i('stick'), i('feather')], [i('arrow', 4)], 'vanilla'),
...
NETS = [
    ...
    ('BONE · FEATHER · FLINT', 'kills · gravel', 'mc:item/bone', [
        f('Bone meal, bone block, white dye', '2x2'), f('Arrows', need='flint + feather'),
...
DECISIONS = [
    ...
    ('Q6', 'Content', 'One rock set',
     'Stone Knife, Flint Knife and Spear overlap with the new set.',
     'The Stone Knife becomes the Rock Sword (London node moves), the Flint Knife goes, and the Spear stays '
     'as the reach weapon.'),
