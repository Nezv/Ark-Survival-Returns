...
- **Homestead economy:** plant the four Ark berries into renewable bushes, feed your tames from a trough, dry raw food into portable rations, and cook hearty stew or trail mix in the cooking pot. The charcoal kiln and primitive forge process logs and ore without fuel while the vanilla furnace remains a valid route, and the 27-slot storage crate pairs with the Load/Unload buttons. See [homestead economy](docs/homestead.md).
