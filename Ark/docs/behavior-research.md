...
The displayed regional rank is now the authority for species eligibility. A plains biome displaying level 5 no longer retains the old hidden apex prohibition. Rex requires 4+, Giga/Titano require 5; none is naturally eligible in level 1. The director now targets three local groups and seeks one varied large encounter when none is present. Large bodies accept bounded uneven ground while retaining full collision checks. Bronto herds spawn with a linked nearby Rex; healthy herds defend members and deter predators, with low-health retreat. Argentavis flock spacing and altitude-weighted spawning reduce lowland crowding. No species has a day/night spawn filter.
