...
public final class FlyingCreatureEntity extends CreatureEntity {
    ...
    public void tickFlight(ServerLevel world) {
        ...
        // Fallen into water or lava mid-lap: flap straight up (a full take-off), never a slow thermal climb.
        if (cruising && (isInWater() || isInLava())) { lap = null; phase(Phase.TAKEOFF); cruising = false; }
