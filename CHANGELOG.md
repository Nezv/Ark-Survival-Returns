...
- **Validation.** Four new JUnit threshold tests and the `mass_load` GameTest (chunk-count checked); all 45 headless GameTests, the full build and `tools/verify_assets.py` pass.
