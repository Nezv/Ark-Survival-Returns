...
- **Validation.** Five new JUnit threshold tests and the `mass_load`, `cargo_load`, `cargo_transfer`, `overload_flight` and `overload_swim` GameTests (chunk-count checked); all 49 headless GameTests, the full build and `tools/verify_assets.py` pass.
