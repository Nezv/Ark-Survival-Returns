...
- **Validation.** Four new JUnit threshold tests and the `mass_load`, `cargo_load` and `cargo_transfer` GameTests (chunk-count checked); all 47 headless GameTests, the full build and `tools/verify_assets.py` pass.
