...
ARK asset: `CeratosaurusAA_Mesh`. 113 original mesh bones, 235 fitted cubes, 53 original animation clips.

Open `Ceratosaurus_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/ceratosaurus.geo.json`, `animations/ceratosaurus.animation.json`, `textures/entity/ceratosaurus.png`.
