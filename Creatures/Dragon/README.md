...
ARK asset: `Dragon`. 149 original mesh bones, 412 fitted cubes, 30 original animation clips.

Open `Dragon_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/dragon.geo.json`, `animations/dragon.animation.json`, `textures/entity/dragon.png`.
