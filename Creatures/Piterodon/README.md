...
ARK asset: `Ptero`. 133 original mesh bones, 287 fitted cubes, 57 original animation clips.

Open `Piterodon_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/piterodon.geo.json`, `animations/piterodon.animation.json`, `textures/entity/piterodon.png`.
