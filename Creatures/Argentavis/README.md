...
ARK asset: `Argentavis`. 131 original mesh bones, 421 fitted cubes, 36 original animation clips.

Open `Argentavis_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/argentavis.geo.json`, `animations/argentavis.animation.json`, `textures/entity/argentavis.png`.
