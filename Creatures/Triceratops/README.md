...
ARK asset: `Trike`. 96 original mesh bones, 258 fitted cubes, 41 original animation clips.

Open `Triceratops_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/triceratops.geo.json`, `animations/triceratops.animation.json`, `textures/entity/triceratops.png`.
