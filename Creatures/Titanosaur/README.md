...
ARK asset: `Titanosaur`. 66 original mesh bones, 319 fitted cubes, 35 original animation clips.

Open `Titanosaur_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/titanosaur.geo.json`, `animations/titanosaur.animation.json`, `textures/entity/titanosaur.png`.
