...
ARK asset: `Rex`. 75 original mesh bones, 232 fitted cubes, 34 original animation clips.

Open `Rex_Ravager_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/rex_ravager.geo.json`, `animations/rex_ravager.animation.json`, `textures/entity/rex_ravager.png`.
