...
ARK asset: `Sauropod`. 65 original mesh bones, 301 fitted cubes, 35 original animation clips.

Open `Brontosaur_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/brontosaur.geo.json`, `animations/brontosaur.animation.json`, `textures/entity/brontosaur.png`.
