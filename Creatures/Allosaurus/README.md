...
ARK asset: `Allosaurus`. 79 original mesh bones, 167 fitted cubes, 32 original animation clips.

Open `Allosaurus_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/allosaurus.geo.json`, `animations/allosaurus.animation.json`, `textures/entity/allosaurus.png`.
