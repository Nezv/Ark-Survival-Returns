...
ARK asset: `Raptor`. 79 original mesh bones, 226 fitted cubes, 35 original animation clips.

Open `Velociraptor_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/velociraptor.geo.json`, `animations/velociraptor.animation.json`, `textures/entity/velociraptor.png`.
