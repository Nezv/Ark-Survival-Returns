...
ARK asset: `Acro_Mesh`. 306 original mesh bones, 418 fitted cubes, 44 original animation clips.

Open `Acrochantosaur_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/acrochantosaur.geo.json`, `animations/acrochantosaur.animation.json`, `textures/entity/acrochantosaur.png`.
