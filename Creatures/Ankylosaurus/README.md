...
ARK asset: `Ankylo`. 76 original mesh bones, 220 fitted cubes, 33 original animation clips.

Open `Ankylosaurus_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/ankylosaurus.geo.json`, `animations/ankylosaurus.animation.json`, `textures/entity/ankylosaurus.png`.
