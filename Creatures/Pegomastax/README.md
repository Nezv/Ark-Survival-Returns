...
ARK asset: `Pegomastax`. 87 original mesh bones, 261 fitted cubes, 42 original animation clips.

Open `Pegomastax_GeckoLib.bbmodel` in Blockbench with the GeckoLib plugin. Geometry, palette texture and all animations are embedded.

Game resources: `geo/pegomastax.geo.json`, `animations/pegomastax.animation.json`, `textures/entity/pegomastax.png`.
